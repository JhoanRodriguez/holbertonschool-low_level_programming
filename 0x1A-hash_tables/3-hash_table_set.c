...
hash_node_t *insert_nodeint_at_index(hash_node_t **head, unsigned long int idx,const char * value, const char *key);
...
int hash_table_set(hash_table_t *ht, const char *key, const char *value)
{
    ...
    insert_nodeint_at_index(ht->array, index, value, key);
	return (1);
